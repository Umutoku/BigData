...
object DataFramesBasics extends App {
  ...
  val firstDF = spark.read
    ...
    .load("spark-essentials/src/main/resources/data/cars.json")
  ...
  /////////////////// 1 //////////
    val smartphoness = Seq(
      (1,"Samsung",4,512,"Galaxy",12),
      (2,"Samsung",16,512,"Galaxy",12),
      (3,"Samsung",8,128,"Galaxy",12),
      (4,"Samsung",2,256,"Galaxy",48)
    )


  val smartphoneDF = spark.createDataFrame(smartphoness)
  ...
  println(s"Total movieDF row ${movieDF.count()}")
